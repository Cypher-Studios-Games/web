...
import { getDatabase, ref, set, get, update, increment } from "https://www.gstatic.com/firebasejs/11.0.1/firebase-database.js";
...
const appCheck = initializeAppCheck(app, {
  provider: new ReCaptchaV3Provider('6LcjkkYsAAAAAHPyVs2SPFW6Cax2-vO5GTZ13R4d'), // Use your Public Site Key
  isTokenAutoRefreshEnabled: true
});

// Export all items you need
export { app, auth, db, ref, set, get, update, increment, createUserWithEmailAndPassword, signInWithEmailAndPassword, signOut };